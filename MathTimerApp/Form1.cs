...
namespace MathTimerApp
{
    public partial class Form1 : Form
    {
        ...
        int minuend;
        int subtrahend;
        // These intger variables store the numbers for the multiplication problem.
        int multiplicand;
        int multiplier;
        ...
        /// <summary>
        /// Start the quiz by filling in all of the problem and starting the timer.
        /// </summary>
        public void StartTheQuiz()
        {
            ...
            difference.Value = 0;
            // Fill in the multiplcation problem.
